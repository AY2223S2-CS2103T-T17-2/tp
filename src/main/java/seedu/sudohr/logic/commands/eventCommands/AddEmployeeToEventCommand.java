...
/**
 * Adds a person using it's displayed index to a specific event using it's
...
public class AddEmployeeToEventCommand extends Command {
    ...
    /**
     * Creates an AddEmployeeToEventCommand to add the person at specified
     * {@code personIndex} to the event at the specified {@code eventIndex}
     */
